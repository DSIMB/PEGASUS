...
def generate_result_pages(result_dict, fasta_file, output_dir='result_pages', predictions_dir='predictions'):
    """
    ...
    for i, prot_id in enumerate(protein_ids):
        ...
        table_rows += f'''
            <tr>
                ...
                <td class="text-center" style="width: 3%;">
                    <a class="btn" role="button" href="{prot_id}_predictions.tsv" download="{prot_id}_predictions.tsv">
                        <!-- Download icon -->
